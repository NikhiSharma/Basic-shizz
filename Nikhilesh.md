...
The field of multi-modal deep learning is rapidly developing [6, 3, 10, 9], with
...
<!-- 
we plan to benchmark the classifier performance and
...
## References
<a id="1">[1]</a> [Pre-training of deep bidirectional transformers for language understanding]<br>
